...
data modify storage place_block_lose_block:data all.disabled append from storage bldp:array_random out.item

function zzz:place_block_lose_block/list/remove_from_enabled with storage bldp:array_random

execute as @a at @s run function zzz:place_block_lose_block/player/notice with storage bldp:array_random out